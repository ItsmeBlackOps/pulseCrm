...
function setup(roleAccess: Record<string, boolean>) {
  (authModule.useAuth as unknown as vi.Mock).mockReturnValue({ user: { userid: 1, roleid: 2 } });
  (accessModule.useRoleAccess as unknown as vi.Mock).mockReturnValue({ roleAccess });
  return render(
    <MemoryRouter>
